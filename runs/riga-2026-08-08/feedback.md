...
- **b. Jāņa sēta map shop** — 4.8 ★ (180). Specialist retail (maps, records, books) has no group in `things-to-do.md` and no query in `research.md`. **Candidate rule:** a specialist-retail sweep. Not proposed — this would be a *new* category, and the smallest-edit test says tighten existing bars first; one trip is far too thin for a new group.
  - **Correction, 2026-08-09 (traveler).** The specialist-retail diagnosis was wrong. What landed was the shopkeeper's passion for maps and getting to look at visual pieces of history and be told about them — not the specialty of the merchandise. Reclassified as evidence for the taste signal in §5 rather than a coverage gap; the specialist-retail candidate is withdrawn in `runs/proposals.md`.
...
- **Visceral and Soviet/Cold-War material rates highest.** Anatomy museum ("really stirs something in you"), KGB headquarters, Cold War military maps were three of the four top-named items. Generalizes as: uncomfortable, physical, or authoritarian-history material over decorative or architectural sightseeing.
  - **Superseded, 2026-08-09 (traveler).** Stated directly: hands-on, interactive and visual beats looking at objects and reading plaques. The subject-matter reading above was one layer too shallow — the common thread across these items and signal 4 below is participation and being shown, not Soviet history. Carried forward as the profile candidate in `runs/proposals.md`.
...
Traveler-profile updates (permitted directly under the profile exception) were **not** applied at the time of the audit — offered and declined; candidates remained signals 1 and 2 in section 5.

### Addendum, 2026-08-09 — profile update applied

Reopened the same day when the traveler restated signal 1 directly and corrected the 3b diagnosis (see the annotations above). Applied with explicit approval:

- **(E) How they engage.** `shared.md`'s traveler profile gains a fourth, cross-cutting line: hands-on, interactive and visual over objects behind glass and plaques on the wall — a workshop, a walkthrough, something to handle or move through — and a knowledgeable enthusiast showing them the thing is itself a reason to go, in any section. Placed as its own profile bullet rather than inside the Things-to-do line because the evidence spans sections: the anatomy museum (Things to do), Gimlet's infusion walkthrough (Cocktail bars), the map shop (Unique to city) and the bike tour (Tours). Different-city effect: a craft workshop, a bar that teaches its program, or a guided maker's studio clears the bar where a comparable static collection would not.

Signal 2 (protein-forward canteen formats) remains declined and open in `runs/proposals.md`. No section file was edited — tightening `things-to-do.md`'s Museums bar to match would be the next-smallest edit if a second trip supports it.
