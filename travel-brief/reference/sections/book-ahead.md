...
Drafted last, in the cross-section pass — its candidates are harvested from the other finished drafts: restaurants, tours/sites/experiences, and ticketed events from the Events section (every sellout-risk flag).
