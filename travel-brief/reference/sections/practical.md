...
1. Ride apps and local transit cards/apps named, not assumed.
2. Fares in local currency and USD, each with its year; nothing invented — "could not confirm" where verification failed.
3. The verdict compares the actual fares above and covers center walkability.
